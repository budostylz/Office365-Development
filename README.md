...
Switch(Self.Selected.ItemKey,
    "DetailsExit",  Set(varMissionSelectV3,Blank()); Clear(colMissionSelectManning);
,
    "DetailsSave",
Concurrent(
Refresh(CurrentOpsList); Patch(CurrentOpsList,LookUp(CurrentOpsList,ID = varMissionSelectV3.MissionListID),
{
    ...
    JSONpersonnel: "[" & 
If(CountRows(SortByColumns(colMissionSelectManning,"percategory",SortOrder.Ascending,"perstartdt",SortOrder.Ascending,"perenddt",SortOrder.Ascending,"pername",SortOrder.Ascending))=0,"",
Concat(SortByColumns(colMissionSelectManning,"percategory",SortOrder.Ascending,"perstartdt",SortOrder.Ascending,"perenddt",SortOrder.Ascending,"pername",SortOrder.Ascending),
"{
...
, // Does the above and below at the same time....
Patch(colMissionListV3,LookUp(colMissionListV3,MissionListID = varMissionSelectV3.MissionListID),
{
    ...
    EarlyReturnDT: MISdetailsEdit_EarlyReturnDT.SelectedDate,
    MissionPersonnel: ForAll(ParseJSON(Text("[" & 
If(CountRows(SortByColumns(colMissionSelectManning,"percategory",SortOrder.Ascending,"perstartdt",SortOrder.Ascending,"perenddt",SortOrder.Ascending,"pername",SortOrder.Ascending))=0,"",
Concat(SortByColumns(colMissionSelectManning,"percategory",SortOrder.Ascending,"perstartdt",SortOrder.Ascending,"perenddt",SortOrder.Ascending,"pername",SortOrder.Ascending),
"{
    ""posntitle"": """ &  Substitute(Substitute(Substitute(Substitute(Trim(posntitle),"""","'"),Char(10)," "),Char(9),""),"/","-") & """,
...
")) & "]")) As ActionPer,
    {
        posntitle: Substitute(Substitute(Substitute(Trim(Text(ActionPer.posntitle)),Char(10)," "),"""","'"),Char(9),""),
...
); // End of Concurrent Function

Set(varMissionSelectV3,Blank()); Clear(colMissionSelectManning);
,
    "DetailsPrint",Set(varMissionPrint,true);
