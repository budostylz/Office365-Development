...
---------------------------------------------------------
    ...
    {
        posntitle: Substitute(Substitute(Substitute(Substitute(Trim(Text(Value.posntitle)), """", "'"), Char(10), " "), Char(9), ""), "/", "-"),
        perdodid: Text(Value.perdodid, "0000000000"),
        pername: Substitute(Substitute(Substitute(Substitute(Trim(Text(Value.pername)), """", "'"), Char(10), " "), Char(9), ""), "/", "-"),
        perfxgrp: Text(Value.perfxgrp),
        permail: Text(Value.permail),
        perstartdt: DateValue(Text(Value.perstartdt)),
        perenddt: DateValue(Text(Value.perenddt)),
        pernotes: Substitute(Substitute(Substitute(Substitute(Trim(Text(Value.pernotes)), """", "'"), Char(10), " "), Char(9), ""), "/", "-"),
