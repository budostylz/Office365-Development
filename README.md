...
[Security Development Lifecycle (SDL) Practices](https://learn.microsoft.com/en-us/training/modules/identify-foundational-components-microsoft-power-platfor/3-describe-power-platform-security-governance)
...
@and(equals(item()?['Checkoutthistitle']?['results']?[0], 'YES'),not(equals(item()?['Check_x0020_out_x0020_date'], null)),or(equals(int(div(sub(ticks(utcNow()), ticks(item()?['Check_x0020_out_x0020_date'])), 864000000000)),45),equals(int(div(sub(ticks(utcNow()), ticks(item()?['Check_x0020_out_x0020_date'])), 864000000000)),59)))
