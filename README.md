...
A SharePoint site page has been successfully created to provide users with a centralized hub for accessing JECC Command calendar permissions, viewing the Command calendar in SharePoint, and submitting Key Leader and Engagements leave requests. This page streamlines calendar management by allowing authorized users to request access to specific calendars based on their role, ensuring proper visibility and control. Additionally, the Key Leader Leave & Engagements request process is fully integrated, enabling users to submit leave and engagement requests directly through SharePoint. Upon submission, a Power Automate flow automatically generates an Outlook event on the Key Leader Leave & Engagements calendar, ensuring seamless scheduling and visibility for leadership.
