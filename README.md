...
The JECC Battle Rhythm Outlook Integration Task is near completion, with Phase 1 at 90% and Phase 2 fully progressing towards deployment. Key milestones include the creation and automation of Battle Rhythm calendars, migration of SharePoint calendar events, integration of the Calendar Access Request Power App, provisioning of a service account by DISA, creation of the SharePoint landing page for JECC Command Calendars, and completion of the test plan. Additionally, the "Key Leader Leave & Engagements" Microsoft Form and Flow have been successfully implemented. A Power Automate-based automation has been built out to modify permissions dynamically upon adding or removing users from the respective calendar admin and contributor O365 groups. Final steps involve addressing UAT feedback & fixes and granting JECC-SPO Members access to calendars, ensuring a seamless and fully functional rollout.
