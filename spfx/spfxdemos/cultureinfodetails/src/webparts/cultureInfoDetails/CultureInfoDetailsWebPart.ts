...
export default class CultureInfoDetailsWebPart extends BaseClientSideWebPart<ICultureInfoDetailsWebPartProps> {
  ...
  public render(): void {
    ...
    <section class="${styles.cultureInfoDetails} ${!!this.context.sdks.microsoftTeams ? styles.teams : ''}">
      <div class="${styles.welcome}">
        ...
        <ul>
          <li><strong>Culture Name</strong>: ${escape(this.context.pageContext.cultureInfo.currentCultureName)}</li>
          <li><strong>UI Culture Name</strong>: ${escape(this.context.pageContext.cultureInfo.currentUICultureName)}</li>
